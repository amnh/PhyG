...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{include.png}
\caption{A simple text file with a list of the terminals to be included in the \phyg analysis.}
\label{include}
\end{figure}

Rather than altering the original data files, we recommend using files such as these
to select terminals for inclusion or exclusion in the analysis.
...
\item Save this file with the name \textbf{dec22\_run1.pg} in a directory \texttt{phygfiles} 
...
\caption{The \phyg output display in the \emph{Terminal} window for the analysis of 
our script dec22\_run1.pg.}
\label{output1}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{crossrefs1.png}\hskip -6ex
\includegraphics[width=0.5\textwidth]{crossrefs2.png}
\caption{Inspecting imported data. The figure shows two crossrefs files, which have 
been imported into \emph{Excel}. The image on the left illustrates an inconsistency 
in the naming of the last taxon \emph{Stenopus\_hispidus}. The name was subsequently
corrected in the "dec\_16S.fas" data file and the script was rerun. The new crossrefs 
file is seen in the image on the right.}
\label{crossrefs}
\end{figure}
