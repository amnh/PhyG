...
%	\end{center}
	...
	\section{Adding New Character Types}
		...
		Functions that branch on character types need to be updates and are found in GraphOptimization.Medians.hs, GraphOptimization.PostOrderFunctions.hs, Commands.Transform.hs, Commands.ComandExecution.hs, Types.Types.hs, Utilities.Utilities.hs,
		Utilities.ThreeWayfunctions.hs, and Support.Support.hs.  Functions with ``== NonAdd'' etc will need extra cases for any new character type.
