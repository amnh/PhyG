...
%		
	\subsection{Support}
		...
		\subsubsection{Description}
		Generates graphs supports via resampling \citep{Farrisetal1996} and Goodman-Bremer \citep{Goodmanetal1982, bremer1994}.  Currently, Jackknifing is the only resampling method that is implemented 
		(as opposed to BootStrapping).
