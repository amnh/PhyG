...
%		\subsubsection{Examples}
	...
	\subsection{Refine}
		...
		\subsubsection{Arguments}
			\noindent \texttt{annealing[:n]} Specifies that $n$ (default 1) rounds of simulated annealing optimization \citep{Metropolisetal1953, Kirkpatricketal1983, Cerny1985} are performed.  The acceptance 
