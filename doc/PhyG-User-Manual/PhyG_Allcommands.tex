...
\label{subsec:swap}
	...
	\begin{description}
		...
		\item[joinPruned] Enables preferences for join strategies. This option can reduce execution time, 
		but at the cost of a less effective search.
...
%		\item[joinAlternate] Only internal---used for testing purposes.
		...
		\begin{description}
			...
			\item[level:1] Equivalent to options \texttt{bestN, joinAll, multiTraverse:False}.
			
			\item[level:2] Equivalent to options \texttt{bestN, joinPruned, multiTraverse:False}. 
