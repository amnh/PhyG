...
\label{subsec:search}
	...
	\begin{description}
		...
		of the search \hl{Wheeler_submitted}. This
		sampling method is a heuristic for timed search decision making. The integer value specifies
		the memory value.
	...
	\begin{example}
		...
		\item{\texttt{search(days:3, thompson:3, linear, mfactor:5)}\\ This command will attempt
