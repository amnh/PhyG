...
\label{subsec:refine}
	...
	\begin{phygdescription}
		{This command implements a number of algorithms involved in ....
		It can performs Genetic Algorithm \citep{Holland1975} for any graph type. In addition, 
	...
	\textbf{Genetic Algorithm} Implements a heuristic search algorithm on a population of
	graphs that mimics the evolutionary process. It includes three components---mutations, 
	...
	\begin{description}
		...
		before retaining the best (lowest cost) solutions. Compare with \texttt{steepest}.
