...
\section{Quick Start}
	...
	\subsubsection{Installing from the binaries}
		...
		website. Binaries are available for MacOS computers with either Intel or M1 processors, 
		and Linux machines (see information relating to Windows machines below).
		The user can go directly to the website, navigate to 
		\href{https://github.com/amnh/PhyGraph/releases}{Releases} and click on the appropriate link 
	...
	\subsubsection{Compiling from the source}
		...
		optimized version of \texttt{PhyG}.
...
\section{Overview of program use}
	...
	\label{subsec:parallel}
		...
		\noindent Note--the Haskell parallelization system PhyG uses does not play well with the hyperthreading of Intel CPUs.  For best performance, 
		hyperthreading on Intel CPUs should be disabled.
