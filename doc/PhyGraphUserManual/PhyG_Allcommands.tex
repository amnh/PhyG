...
\subsection{Search}
	...
	\subsubsection{Defaults}
		\texttt{search()} Performs 1 iteration of 30 seconds keeping up to 10 graph}.
...
\subsection{Set}
	...
	\subsubsection{Arguments}
		\begin{description}
			...
			\item[partitioncharacter] Sets the character that is used to partition data. %\hl{The separator can be something else}
