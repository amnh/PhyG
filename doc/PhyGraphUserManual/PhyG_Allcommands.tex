...
\label{subsec:refine}
	...
	\begin{phygdescription}
		{Performs edit operations (addition, deletion, and move) on network edges, and 
		therefore only applies to softwired and hardwired graphs. This also includes
		the use of Genetic Algorithm for any graph type.}
	\end{phygdescription}
