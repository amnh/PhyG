...
\label{subsec:refine}
	...
	\begin{phygdescription}
		{Performs Genetic Algorithm for any graph type. In addition is performs edit operations 
		(addition, deletion, and move) on network edges, and therefore only applies to softwired 
	...
	\begin{description}
		...
		\texttt{recombinations}. 
			...
			\texttt{geneticAlgorithm}. The default is10.
			...
			\texttt{geneticAlgorithm}. The default is 100.
