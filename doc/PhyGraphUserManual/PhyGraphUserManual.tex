...
\section{Input Data Formats} 
	...
	\texttt{Lingula\_anatina} by the program.
	...
	\subsection{\texttt{TNT}}
		...
		step-matrix costs, interleaved data files and continuous characters. Continuous 
...
\section{Output Graph Formats}
	...
	PDFs of dot files can be generated directly (option \texttt{report}) or manually.  Example 
	dot command line: }
	...
	On OSX the `pdf' option does not currently seem to work. You can use `-Tps2' and 
	that will generate 
...
\section{\phyg Command Structure}
	...
	\subsection{Brief description}
		...
		the colon \texttt{(``:'')} character. Examples of 
		...
		In this third and final example, the command \texttt{set} is followed by the labeled-
		value argument \texttt{graphfactor} with the labeled-value \texttt{nopenalty}.
