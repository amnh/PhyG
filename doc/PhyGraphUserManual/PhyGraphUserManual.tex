...
\section{Input Data Formats} 
	...
	\subsection{\texttt{TNT}}
		...
		Ambiguities or ranges are denoted in square brackets (\texttt{[ ]}) with a period (e.g. [X.Y]). 
		Continuous characters are denoted in square brackets with a dash or hyphen, as in [X-Y]).
