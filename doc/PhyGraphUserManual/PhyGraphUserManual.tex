...
\section{Overview of program use}
	...
	\subsection{Executing Scripts}
		...
		of the file and provide other useful annotations can be included. Comments are 
...
\section{Input Data Formats} 
	...
	(aligned and unaligned), Hennig86, and fastc formats. Any character names in 
	...
	Qualitative data, and prealigned data include their index in their input files and 
	unaligned data are treated as a single character.
...
\section{\phyg Command Structure}
	...
	\subsection{Brief description}
		...
		It also read the data in the file ``\textbf{sg1t1.mat}'', parsing it as a transformation cost matrix, 
