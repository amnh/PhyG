...
\chapter{What is PhyG?}
	...
	including forests and both soft- and hard-wired networks. \phyg \hl{generates ...}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%		
	\section{Quick Start}
		...
		There are no particular size requirements for disk space, although \hl{graphs and network
		...
		\phyg source code, precompiled binaries, test data, and documentation in pdf format, %as well as tutorials
		...
		\noindent The binary should either be moved into your \$PATH or referred to at its 
		current location when executing a script.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	 		
	\section{Overview of program use}
		...
		\noindent in a \textit{Terminal} window will invoke \phyg to run the script \texttt{mol.pg} in 
		the directory \texttt{/Users/username/phygfiles}. 
...
\section*{Acknowledgments}
	The authors would like to thank DARPA SIMPLEX N66001-15-C-4039, the Robert J. Kleberg Jr. and Helen C. 
