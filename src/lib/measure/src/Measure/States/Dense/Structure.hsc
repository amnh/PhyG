...
module Measure.States.Dense.Structure
  ( AlignmentStrategy(..)
  , TCMρ(..)
  , FFI2D()
  , FFI3D()
...
data  TCMρ
    = TCMρ
    { gapPenalty :: {-# UNPACK #-} Distance
    , maxDelCost :: {-# UNPACK #-} Distance
    , maxInsCost :: {-# UNPACK #-} Distance
    , minDelCost :: {-# UNPACK #-} Distance
    , minInsCost :: {-# UNPACK #-} Distance
...
{-# SPECIALISE INLINE getTCMρ2D :: TCMρ -> CUInt -> CUInt -> (Distance, CUInt) #-}
getTCMρ2D
  :: ( Enum a
     , Enum b
     , Enum c
...
{-# SPECIALISE INLINE getTCMρ3D :: TCMρ -> CUInt -> CUInt -> CUInt -> (Distance, CUInt) #-}
getTCMρ3D
  :: ( Enum a
     , Enum b
     , Enum c
