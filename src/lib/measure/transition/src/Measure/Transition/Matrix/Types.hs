-----------------------------------------------------------------------------
-- |
-- Module      :  Measure.Transition.Matrix.Types
...
type SCMλ = SymbolIndex -> SymbolIndex -> SymbolChangeCost
...
type TCM2Dλ e = e -> e -> (SymbolChangeCost, e)
...
type TCM3Dλ e = e -> e -> e -> (SymbolChangeCost, e)
