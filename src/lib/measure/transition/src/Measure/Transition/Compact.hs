...
import qualified Measure.Transition.Compact.Discrete         as Dis
import qualified Measure.Transition.Compact.DiscreteCrossGap as Gap
import qualified Measure.Transition.Compact.L1Norm           as L1N
...
data  CompactMeasure a
    ...
    | ExplicitLayoutλ   {-# UNPACK #-} SCMρ        {-# UNPACK #-} SymbolChangeCost {-# UNPACK #-} SymbolChangeCost (TCM2Dλ a) (TCM3Dλ a)
    | DiscreteCrossGapρ {-# UNPACK #-} TCMρ
    | DiscreteCrossGapλ {-# UNPACK #-} SymbolCount {-# UNPACK #-} SymbolChangeCost {-# UNPACK #-} SymbolChangeCost
...
-- |
-- Nullary constructor for the <https://en.wikipedia.org/wiki/Discrete_space discrete metric>.
discreteCrossGap :: SymbolChangeCost -> SymbolChangeCost -> SymbolCount -> CompactMeasure a
