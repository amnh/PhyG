-----------------------------------------------------------------------------
-- |
-- Module      :  Measure.Transition.Compact.DiscreteCrossGap
...
import Measure.Transition.States.Dense   (TCMρ, fromSCMρ, fromSCMλ)
...
scmλ :: SymbolChangeCost -> SymbolChangeCost -> SCMλ
scmλ g s i j
  | i == j    = 0
  | i == 0    = g
  | j == 0    = g
