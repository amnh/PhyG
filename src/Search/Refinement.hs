...
--                    logWith LogInfo $ bannerText <> "\n"
                    (newGraphList, counterAdd) <- do if doNetAdd
                                                     then
