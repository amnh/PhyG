                                ...
                                Just keep → case thresholdParam of
                                    ...
                                    Just threshold →
                                        let -- minimum graph cost
                                            ...
                                            result :: Evaluation env [(SimpleGraph, VertexCost, DecoratedGraph, V.Vector [LG.Gr a b], V.Vector (V.Vector (LG.Gr a b)), V.Vector (V.Vector CharInfo))]
                                            result
...
getBVUniqPhylogeneticGraph nonZeroEdges = \case -- inPhyloGraphList =
    [] -> []
    inPhyloGraphList -> 
