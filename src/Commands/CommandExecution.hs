                    ...
                    True → case firstCommand of
                        ...
                        "criterion" → do
                            ...
                            (lGraphComplexityList, lRootComplexity) ← case localCriterion of
                                ...
                                val
                                    | val `elem` [PMDL, SI] →
                                        pure $ (U.calculateGraphComplexity &&& (U.calculatePMDLRootCost True Nothing)) origProcessedData
                    ...
                    _ → case firstCommand of
                        ...
                        "rootcost" → do
                            ...
                            lRootComplexity ← case localMethod of
                                NoRootCost → pure 0.0
                                val | val `elem` [Wheeler2015Root, PMDLRoot] → pure $ U.calculatePMDLRootCost True Nothing origProcessedData
