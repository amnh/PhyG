...
parserDescription = getProgName <&> \name ->
    let projectLess = fromString $ nameAbbreviation projectName
        ...
        progInfo =
            let sentences = 
                    [ programLong : parens programLess : words' "is a multi-platform program designed to produce phylogenetic graphs from input data and graphs via heuristic searching of general phylogenetic graph space."
                    ...
                    , "What" : "sets" : programLess : words' "apart from other phylogenetic analysis programs, is the extension to broader classes of input data and phylogenetic graphs."
