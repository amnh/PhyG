            ...
            progInfo =
                let sentences =
                        [ programLong
                            : parens programLess
                            : words'
                                "is a multi-platform program designed to produce phylogenetic graphs from input data and graphs via heuristic searching of general phylogenetic graph space."
                        , words' "The bio-informatics framework libraries of the broader"
                            <> [projectMore, parens projectLess]
                            <> words' "project are the foundation upon which"
                            <> [programLess]
                            <> words' "is constructed."
                        , programLess
                            : words'
                                "offers vast functionality, including the optimization of unaligned sequences, and the ability to implement search strategies such as random addition sequence, swapping, and tree fusing."
                        , "Furthermore,"
                            : programLess
                            : words' "can generate outputs in the form of implied alignments and graphical representations of cladograms and graphs."
                        , "What"
                            : "sets"
                            : programLess
                            : words'
                                "apart from other phylogenetic analysis programs, is the extension to broader classes of input data and phylogenetic graphs."
                        , words' "The phylogenetic graph inputs and outputs of"
                            <> [programLess]
                            <> words' "include trees, as well as softwired and hardwired networks."
                        ]
