...
splashImage =
    [||
    renderStrict . layoutPretty (LayoutOptions Unbounded) . indent 1 $
        vsep
            [ " _____ _          ___ _  _   _   _  _ ___   ___          _        _"
            , "|_   _| |_  ___  | _ \\ || | /_\\ | \\| | __| | _ \\_ _ ___ (_)___ __| |_"
            , "  | | | ' \\/ -_) |  _/ __ |/ _ \\| .` | _|  |  _/ '_/ _ \\| / -_) _|  _|"
            , "  |_| |_||_\\___| |_| |_||_/_/ \\_\\_|\\_|___| |_| |_| \\___// \\___\\__|\\__|"
            , "  ___                     _        _                  |__/"
